package com.dinesh.dagger.v1.constructor_method
...
private val TAG = "log_CoffeeShop_Constructor_Method"
...
class DI {
    fun main() {
        // Create Dagger CoffeeMachineComponent
//        val coffeeMachineComponent = DaggerCoffeeComponent.builder().build()
